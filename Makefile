...
SRC = $(SRCDIR)/$(TARGET).c                                  \
	  ...
	  $(LUFA_PATH)/Drivers/USB/Class/HIDParser.c             \
...
#CDEFS += -DUSB_STREAM_TIMEOUT_MS=250
...
# Create object files directory (and any subhierarchy)
$(shell mkdir -p $(OBJDIR) $(dir $(OBJ)))
